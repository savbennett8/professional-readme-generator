...
let licenseBadge = function renderLicenseBadge(license) {
    if (!license) {
        return '';
    }
    else if (license === 'MIT') {
...
// If there is no license, return an empty string
let licenseLink = function renderLicenseLink(license) {
    if (!license) {
        return '';
    }
    else if (license === 'MIT') {
...
// If there is no license, return an empty string
let licenseSection = function renderLicenseSection(license) {
    if (!license) {
        return '';
    }
    return `
